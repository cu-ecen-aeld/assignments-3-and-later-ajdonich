 ...
 * the joiner thread.
 * Set thread_complete_success to true if the thread completed 
 * with success, false if an error occurred.
 */
struct thread_data {
    // Note: useconds here
    useconds_t wait_to_obtain_us;
    useconds_t wait_to_release_us;
